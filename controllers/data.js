...
},
{
    ...
    questions : [
        {
            id : 1,
            question : "Identify the incorrect statement about compilation and execution of java programs",
            options : ["javac helps in compiling the java program and creates the .class files", 
        ...
        {
            id : 3,
            question : "Which command is used to change the I/O characteristics of the terminal?",
        ...
        },
        {
            ...
            options : ["static methods can call other static methods only", 
        ...
        {
            id : 8,
            question : "When invoking a method with an object argument, ___________ is passed.",
            options : ["the contents of the object", "a copy of the object", 
            "the reference of the object", "the object is copied, then the reference of the copied object"],
            answer : "the reference of the object"
        },
        {
            id : 9,
            question : "Choose the correct option.",
            options : ["Recursion is always better than iteration.", 
        ...
        },
        {
            ...
            options : ["They are in different memory spaces", "They are in different logical addresses", 
            "They have a protection algorithm", "Every address generated by the CPU is being checked against the relocation and limit registers"],
        ...
        {
            id : 13,
            question : "The program is interrupted by_________ command in appropriate way.",
        ...
        {
            id : 15,
            question : "The entry of all the PCBs of the current processes is in __________",
        ...
        },
        {
            ...
            options : ["other threads in the another process can also read from that file", 
        ...
        },
        {
            ...
            options : ["Efficient implementation of multi-user support is no longer possible", 
        ...
        {
            id : 18,
            question : "In Process Address Space, The variable names, constants, and instruction labels are the basic elements of ____________.",
            options : ["Symbolic addresses", "Relative addresses", "Physical addresses", "None of the above"],
            answer : "Symbolic addresses"
        },
        {
            id : 19,
            question : "In which type of Fragmentation, Memory block assigned to process is bigger. Some portion of memory is left unused, as it cannot be used by another process.",
            options : ["External fragmentation", "Internal fragmentation", "Both of the above", "None of the above"],
            answer : "Internal fragmentation"
        },
        {
            id : 20,
            question : "A swapper manipulates ___________ whereas the pager is concerned with individual _______ of a process.",
            options : ["the entire process, parts", "all the pages of a process, segments", "the entire process, pages", "none of the mentioned"],
            answer : "the entire process, pages"
        },
        {
            id : 21,
            question : "Segment replacement algorithms are more complex than page replacement algorithms because ____________",
            options : ["Segments are better than pages", "Pages are better than segments", 
            "Segments have variable sizes", "Segments have fixed sizes"],
        ...
        },
        {
            ...
            options : ["i, ii and iii only", "ii, iii and iv only", "i, ii and iv only", "All i, ii, iii and iv"],
            answer : "i, ii and iv only"
        },
        {
            id : 26,
            question : "In which of the following Algorithm where the reference bit is used to determine whether a page has been recently referenced, and some page that has not been recently referenced is replaced?",
            options : ["LRU Page replacement Algorithm", "FIFO page replacement Algorithm", "Optimal page replacement algorithm", "NRU Page replacement algorithm"],
            answer : "NRU Page replacement algorithm"
        },
        {
            id : 27,
            question : "In which of the following Page replacement Policy, at every page fault the page replacement policy replaces the page that was loaded into memory earlier than any other page of the process?",
            options : ["LRU Page replacement Algorithm", "FIFO page replacement Algorithm", "Optimal page replacement algorithm", "NRU Page replacement algorithm"],
            answer : "FIFO page replacement Algorithm"
        },
        {
            id : 28,
            question : "In UNIX, the set of masked signals can be set or cleared using the ________ function.",
            options : ["sigprocmask", "sigmask", "sigmaskproc", "sigproc"],
            answer : "sigprocmask"
        },
        {
            id : 29,
            question : "In most cases, if a process is sent a signal while it is executing a system call :",
            options : ["the system call will continue execution and the signal will be ignored completely", 
        ...
        },
        {
            ...
            options : ["Negative integer, Zero", "Zero, Negative integer", "Nonzero integer, Zero", "Zero, nonzero integer"],
            answer : "Zero, nonzero integer"
        },
        {
            id : 31,
            question : "When the operating system has performed a_____ operation, it has two choices for selecting a process either admitting a newly created process or bring in a previously suspended process.",
        ...
        {
            id : 33,
            question : "Which of the following command is used to display only directories that exist in the current directory?",
            options : [`ls -l | grep "^d`, `ls | grep "^d"`, `ls -l | grep "#d"`, `ls -l | grep "*d"`],
            answer : `ls -l | grep "^d`
        },
        {
            id : 34,
            ...
            options : ["resource allocation state", "system storage state", "operating system", "resources"],
        ...
        },
        {
            ...
            options : ["all threads of a process share the same address space", "all threads of a process share the same global variables", 
            "all threads of a process can share the same files", "all of the mentioned"],
            answer : "all of the mentioned"
        },
        {
            id : 37,
...
main()
{
    ...
    sleep(100);
            ...
            options : ["an orphan process", "a zombie process", "a process that executes forever", "none of the mentioned"],
        ...
        },
        {
            ...
            options : ["becomes less", "becomes more", "remains constant", "none of the mentioned"],
            answer : "becomes more"
        },
        {
            id : 39,
            ...
            options : ["the segments are invalid", "the processes get blocked", 
            "segments are shared", "all of the mentioned"],
